  ...
  return (
    <div className="analog-card">
      ...
      <div className="analog-article">
        ...
        시간이 흐르며 사람들은 <span className="analog-highlight-blue">화려한 복식</span>과 <span className="analog-highlight-blue">시끄러운 꽹과리</span>에 더 끌리게 되었지만, 중요한 순간마다 <span className="analog-highlight-pink">이야기꾼</span>들은 여전히 '푸른 나팔'을 꺼내들었어요.<br/>
